...
public class TasksHandlerTest {
    ...
    public void testPostTask() throws IOException, InterruptedException {
        ...
        checkTaskEquality(task, tasksFromManager.get(0));
    }
    ...
    public void testDeleteTaskById() throws IOException, InterruptedException {
        ...
        // проверяем идентичность задач
        checkTaskEquality(task2, tasksFromManager.get(0));
    }
    ...
    private void checkTaskEquality(Task expected, Task actual) {
        ...
        assertEquals(expected.getTitle(), actual.getTitle(), "Некорректное имя задачи");
